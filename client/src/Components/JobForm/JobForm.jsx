...
export const JobForm=()=> {
  ...
  useEffect(()=>{
    ...
    if(id){
        ...
        fetch(`https://job-seeker-zbzl.onrender.com/api/job/job-posts/${id}`, options)
 ...
 const data = {...formData, name:recruiterName}
  ...
  try {
    const response = await fetch("https://job-seeker-zbzl.onrender.com/api/job/job-posts", {
      method: "POST",
      headers: {
 ...
 const data = {...formData, name:recruiterName}
  // Send the POST request
  try {
    const response = await fetch(`https://job-seeker-zbzl.onrender.com/api/job/job-posts/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "Authorization": token
